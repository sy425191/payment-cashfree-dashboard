...
const Sidebar = () => {
  return (
    <div className="w-full md:max-w-[220px] md:min-w-[220px] h-full flex flex-col justify-between bg-[#1E2640] text-white/90 p-3">
      <div className="">
        ...
        <div className="mt-2 hidden md:block">
          {SidebarColumns.map((val) => {
            return (
              <SidebarCard key={val.key} icon={val.icon} title={val.title} />
            );
          })}
        </div>
      </div>
